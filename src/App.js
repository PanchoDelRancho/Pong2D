    ...
    <>
       <div style={{ position: "absolute" }}>
        ...
        <div className='subtitle'>About Me</div>
          After years working in the<text className='powerBlock'>manufacturing</text>industry I decided that in
          order to unlock my potential I would apply myself to <text className='powerBlock'>learning</text>
          something I am truly interested in. And so began my web development
          journey. I love working with code and using software to <text className='powerBlock'>solve problems</text>
          . I consider myself a fast and lifelong learner with a
          <text className='powerBlock'>dedication</text> to improving myself and my skills. I hope that I can be the
          person that brings <text className='powerBlock'>value</text> to your company through my work.
        </div>
        <div className="text">
